const translations = {
  fr: {
    ...
    s3_title: "Serrurerie",
    s3Text: "Ouverture, changement de serrures, sécurisation.",
    s4_title: "Équipements Thermiques (Chaud & Froid)",
    s4Text: "Climatiseurs, chauffages, réfrigérateurs, congélateurs, gazinières et équipements thermiques.",
    s5_title: "Menuiserie",
    s5Text: "Réparations, ajustements, petites installations.",
    s6_title: "Maçonnerie",
    s6Text: "Petits travaux, réparations, finitions.",
    s7_title: "Urgences 24/7",
    s7Text: "Interventions rapides pour pannes critiques.",
    s8_title: "Maintenance préventive",
    s8Text: "Inspections et entretien pour éviter les pannes.",
  ...
  en: {
    ...
    s3_title: "Locksmith",
    s3Text: "Door opening, lock changes, securing.",
    s4_title: "Thermal Equipment (Hot & Cold)",
    s4Text: "Air conditioners, heaters, refrigerators, freezers, cookers and thermal systems.",
    s5_title: "Carpentry",
    s5Text: "Repairs, adjustments, small installations.",
    s6_title: "Masonry",
    s6Text: "Small works, repairs, finishing.",
    s7_title: "24/7 Emergencies",
    s7Text: "Fast response for critical issues.",
    s8_title: "Preventive maintenance",
    s8Text: "Inspections and upkeep to avoid breakdowns.",
